# This is a repository to run ZeroTier Agent or Controller on VyOS router as a Docker container
...
## To make it work first install docker container app on VyOS https://github.com/qdrddr/VyOS/blob/main/1.3.1/vyos-docker-install.script
...
[Controller](https://github.com/qdrddr/VyOS/blob/main/1.3.1/zt-controller.script)<br />
...
[Agent](https://github.com/qdrddr/VyOS/blob/main/1.3.1/zt-agent.script)<br />
Make a file in the /config folder, copy and paste content of the script and make it executable.
